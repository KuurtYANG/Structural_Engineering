...
"""
The units for this script are mm, N, tonne, s and MPa.
The final results include a true stress-plastic strain curve and its corresponding excel file that can be imported to ABAQUS directly.
"""
import math
import numpy as np
import pandas as pd
